...
public class ResourceMapper {
    ...
    /**
     * Generic method to map a Page to a list of DTOs
     */
    ...
    /**
     * Generic method to create a paginated response
     */
    public static <T, R> ResourceSearchResponse<R> createPaginatedResponse(Page<T> page, Function<T, R> mapper) {
        List<R> content = mapPageToList(page, mapper);
     ...
     */
    private static void addReferenceMaterialSpecificFields(ReferenceMaterial refMaterial, 
    ...
    public static <T extends Resource> ResourceSearchResponse<ResourceSummaryResponse> toResourceSearchResponse(Page<T> resourcePage) {
        return createPaginatedResponse(resourcePage, ResourceMapper::toResourceSummaryResponse);
    }
...
//                .passingScore(quiz.getPassingScore())
    ...
    /**
     * Converts a CreateReferenceMaterialRequest DTO to a ReferenceMaterial entity
     */
